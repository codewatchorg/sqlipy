...
Description:    This plugin leverages the SQLMap API to initiate SQLMap scans against the target.  This
version works with the free edition of Burp Suite.
...
class ThreadExtender(IBurpExtender, IContextMenuFactory, ITab):
          ...
          if resp['returncode'] == 0:
            ...
            try:
              ...
              if vulnerable:
                ...
                findings.write('<html><head>SQLMap Scan - ' + self.sqlmaptask + '</head><body>')
...
class BurpExtender(IBurpExtender, IContextMenuFactory, ITab):
  ...
  def printHeader(self):
    print 'SQLiPyFree - 0.3.9\nBurp Free edition interface to SQLMap via the SQLMap API\njosh.berry@codewatch.org\n\n'
